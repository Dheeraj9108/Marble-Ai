...
const Main = () => {
    return (
        <>
            <main className="col main mt-3 h-100 overflow-auto" style={{ background: "#202124", marginLeft: "12px", scrollbarWidth: "none" }}>
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="tab-content">
                            ...
                            <div role="tabpanel" className="tab-pane active" id="home1">
                                <h4>Home</h4>
                                <p>1. These Bootstrap 4 Tabs work basically the same as the Bootstrap 3.x tabs.
                                    <br />
                                    <br />
